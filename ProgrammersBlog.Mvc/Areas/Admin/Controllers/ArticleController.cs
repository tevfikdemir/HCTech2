    ...
    public class ArticleController : BaseController
    {
        ...
        public async Task<IActionResult> Add(ArticleAddViewModel articleAddViewModel)
        {
            if (ModelState.IsValid)
            {
                ...
                var imageResult =  _imageHelper.Upload(articleAddViewModel.Title, articleAddViewModel.ThumbnailFile, PictureType.Post);
                articleAddDto.Thumbnail = imageResult;
                var image = articleAddViewModel.ThumbnailFile.FileName;
                articleAddDto.Thumbnail = imageResult;//image;
                articleAddDto.SeoAuthor = "Admin";
                articleAddDto.SeoDescription = "Tekstil Planlama";
                articleAddDto.SeoTags = "Personel Takip";
